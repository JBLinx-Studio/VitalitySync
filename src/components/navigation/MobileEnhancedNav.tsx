    ...
    <div className="w-full max-w-sm">
      <ScrollArea className="h-[80vh] w-full">
        ...
        <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-slate-800 dark:via-purple-800 dark:to-slate-800 rounded-2xl overflow-hidden">
          <div className="absolute inset-0 bg-white/10 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl"></div>
            ...
            {categories.map((category) => (
              <div key={category.id} className="space-y-2">
                <Button
                  ...
                  className="w-full justify-between p-4 rounded-xl transition-all duration-300 text-white/80 hover:text-white hover:bg-white/10"
                >
